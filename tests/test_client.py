...
'''
        ...
        #response = self.client.post('/paint/get_figure',
        #                            data={coordinates: coordinates})
        self.assertEqual(response.status_code, 200)
        self.assertTrue('figure tag' in response.get_data(as_text=True))
